  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-3xl mx-auto glass-card p-12 text-center relative overflow-hidden">
        ...
        <Link
          to={"/analyse"}
          className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-base font-semibold bg-white/6 border border-white/10 text-white transition-colors"
        >
          Analyse Now <ArrowRight size={16} />
        </Link>
      </div>
    </section>
  );
