...
export const Features = [
  ...
  },
  {
    ...
    desc: "After analysing your resume, HIREMind AI matches you with roles that actually fit your skills and experience — no more applying blindly and wondering why you hear nothing back.",
    bullets: [
...
<div class="footer">Generated by HIREMind AI · ${new Date().toLocaleDateString(
    "en-IN",
